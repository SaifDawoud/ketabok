...
class SuraTab extends StatelessWidget {
          ...
          child: ListView.separated(
            ...
            separatorBuilder: (BuildContext context, int index) {
              return Padding(
                ...
                child: Divider( thickness: 1.2,color: const Color(0xFF7B80AD).withOpacity(.35)),
              );
            },
  ...
  Widget suraItem({required Sura sura,required BuildContext context}) => InkWell(
    onTap: (){Navigator.of(context).pushNamed(SuraDetails.routName,arguments: {'sura':sura});},
          child: Row(
        children: [
          Stack(children: [
